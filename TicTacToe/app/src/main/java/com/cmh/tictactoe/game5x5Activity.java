...
public class game5x5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonNewGame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(game5x5Activity.this, ChoiceBoardActivity1.class);
                game5x5Activity.this.startActivity(myIntent);
            }
        });
    ...
    public void onClick(View v) {
        ...
        if (player1Turn) {
            ...
            MediaPlayer player1Song = MediaPlayer.create(game5x5Activity.this, R.raw.player1sound);
            player1Song.start();

            playerTurn.setText("Player 2");
        } else {
            ((Button) v).setText("X");
            MediaPlayer player2Song = MediaPlayer.create(game5x5Activity.this, R.raw.player2sound);
            player2Song.start();
